...
- Missing root pin, wrong root, token-only configuration and invalid sound rejected.
...
- A decryptable approval grant with a wrong pinned account root was rejected.
